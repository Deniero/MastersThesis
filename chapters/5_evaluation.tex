...
9 Vehicles and 5 pedestrians. same number as start scenario 1.\todo{Not yet implemented}


\section{Start Scenario 3}
Start Scenario 3 is described in more detail in Appendix \todo{ref}. 5 vehicles with 3 pedestrians are initialized, resulting in the simulation with the least NPCs.
\begin{figure}[ht] 
