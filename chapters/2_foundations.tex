...
This chapter will provide an overview of both genetic algorithms as well as behaviour trees.
...
\begin{itemize}
	...
	\begin{itemize}
		\item \textbf{Action nodes:} These nodes execute a command upon receiving a tick and can return "Success," "Failure," or "Running." Typically, action nodes execute the behaviour of an agent, such as "open\_door()".
