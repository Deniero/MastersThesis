...
for i in range(len(result["ego_emergency_stop"])):
	if not result["ego_emergency_stop"][i]:
		# base cost for no current emergency break
		cost = cost + 1
		duration_counter = 0
	else:
