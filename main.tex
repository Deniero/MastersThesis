...
%% general metadata:
\newcommand{\myauthor}{Daniel Sumann}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, BSc}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Method of Hyperparameter Optimization of a Genetic Algorithm applied in Critical Scenario Generation for Autonomous Vehicles}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubtitle}{ }  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\mysubject}{Optimization of Hyperparamter of a a Genetic Algorithm using the Taguchi Method applied in Critical Scenario Generation for Autonomous Vehicles}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{Genetic Algorithm, Critical Scenario Generation, Autonomous Vehicle Testing, Taguchi Method, Optimization}  %% also used for PDF metadata (hyperref)
...
\newcommand{\myinstitutehead}{Univ.-Prof.\,Dipl.Ing.\,Dr.techn.~Franz Wotawa} %% head of institute
\newcommand{\mysupervisor}{Univ.-Prof.\,Dipl.Ing.\,Dr.techn.~Franz Wotawa} %% your supervisor
\newcommand{\mycosupervisor}{Dr. Florian Klück}  %% only used with title_Thesis_TU_Graz_-_kazemakase
%\newcommand{\myevaluator}{Univ.-Prof.\,Dipl.Ing.\,Dr.techn.~Franz Wotawa} %% your evaluator
\newcommand{\myhomestreet}{Viktor Geramb Str. 43} %% your home street (with house number)
\newcommand{\myhometown}{Seiersberg-Pirka} %% your home town
\newcommand{\myhomepostalnumber}{8054} %% your postal number of home town
...
\newcommand{\myid}{11705231} %% Matrikelnummer
...
\include{chapters/4_hyperparameter_tuning}
