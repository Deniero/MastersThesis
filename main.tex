...
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, BSc}  %% including
                                ...
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Evaluation of a Genetic Algorithm on Searching for critical Scenarios in a Traffic Simulation}  %% also used for PDF metadata (hyperref)
...
\include{chapters/7_future_work}
